...
1. Open any file explorer app in your game device and navigate to the game folder:
  - For Bubble Bug Co Demo, navigate to
    - `.../Android/data/com.roberteoh.bubblebugcodemo/files/`
  - For Bubble Bug Co, navigate to
    - `.../Android/data/com.roberteoh.bubblebugco/files/`
